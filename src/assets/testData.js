...
export const people = [
  {
    ...
    isStaff: true,
    isStudent: true,
    website: "https://socialsciences.mcmaster.ca/people/van-der-linden-clifton",
  },
  {
    name: "clifton van der linden",
    titles: [],
...
export const persons = {
  ...
  titles: ["digital society lab founder", "faculty of social science"],
  website: "https://socialsciences.mcmaster.ca/people/van-der-linden-clifton",
  email: "cliff@digitalsocietylab.org",
  isStaff: true,
  isStudent: true,
  tags: [
  ...
  profile: [
    "Dr. van der Linden’s academic interests centre on the implications of technology for both the practice and study of politics. His research explores the relationships between digital technologies and patterns of democratic participation. He is also actively engaged in the application of new, technologically-enabled methods—such as the use of Big Data and machine learning—to the study of political behaviour and public opinion. His publications have appeared in highly-respected peer-reviewed journals such as Political Analysis, the International Journal of Forecasting, Political Science Quarterly, the Journal of Elections, Public Opinion and Parties, Nations and Nationalism, the Journal of Experimental Political Science, Politics and Gender, Canadian Public Policy, and the Canadian Journal of Political Science.",
  ...
  projects: [
    {
      ...
      subtitle:
        "Project One: Microsoft Bing’s Chinese Political Censorship of Autosuggestions in North America",
  ...
  publications: [
    {
      title:
        "Conflicting Nationalisms: The Voice of the Subaltern in Mahasweta Devi's Bashai Tudu, by Alaknada Bagchi.",
      url: "http://trybut.fail/",
      date: "January 2023 ",
    },
  ],
  GlobeLogo,
...
export const projects = [
  {
    title: "GeckoSpy",
    subtitle: "Pegasus Spyware Used against Thailand’s Pro-Democracy Movement",
    about:
