...
const LeftPane = ({
	...
	const { name, titles, tags, img, email, website } = profileData?.[0] || {
		name: "",
		titles: [""],
		tags: [""],
		img: {},
					...
					{website && (
						<li className="item">
							...
							>
								...
								<span className="medium-16 links-title">website</span>
							</a>
						</li>
					)}
					{email && (
						<li className="item">
							<a className="links email" href={`mailto:${email}`}>
								...
								<span className="medium-16 links-title">email</span>
							</a>
						</li>
					)}
				</ul>
