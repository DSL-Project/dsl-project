...
function Home() {
    const handleSubmit = () => {
        window.open(
            'https://buttondown.email/digitalsocietylab',
            'popupwindow'
        );
    };
            ...
            <div className='home-wrapper'>
                <div className='welcome-container'>
                    ...
                    <div className='regular-16'>
                        {homeStatic.homebody.content.map(
                            (outerItem, outerIndex) => (
                                <div key={outerIndex}>
                                    {outerItem.content.map(
                                        (innerItem, innerIndex) => (
                                            <div key={innerIndex}>
                                                ...
                                                {innerIndex !==
                                                    outerItem.content.length -
                                                        1 && (
                                                    <div
                                                        key={`line-break-${innerIndex}`}
                                                    >
                                                        <br />
                                                    </div>
                                                )}
