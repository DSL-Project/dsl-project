            ...
            <div className='training-wrapper'>
                <div className='training-container'>
                    ...
                    <p className='regular-16'>
                        ...
                        innovative curriculum which seeks to bridge public
                        policy thinking with technical expertise. The program
                        trains prospective policy leaders to navigate the
                        rapidly changing dynamics of the technological landscape
                        so as to more effectively address the complex social,
                        political, and economic challenges that have accompanied
                        the digital age.
                    </p>
